  ...
  def destroy
    ...
    if @contact.destroy
      if profileContact.destroy
        ...
        respond_to do |format|
          format.html { redirect_to root_path, :flash => { :error => "Profile contact was not deleted" } }
        end
      end
    else
      respond_to do |format|
        format.html { redirect_to root_path, :flash => { :error => "Could not delete the contact" } }
      end
    end
  end
